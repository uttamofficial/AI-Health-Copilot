  ...
  const features = [
    {
      ...
      description:
        "Get intelligent health recommendations powered by advanced machine learning algorithms.",
    ...
    },
    {
      ...
      description:
        "Visualize your symptoms on an interactive 3D body model for better tracking.",
    ...
    },
    {
      ...
      description:
        "Advanced AI detects unusual patterns in your health data before they become serious.",
    ...
    },
    {
      ...
      description:
        "Chat with our intelligent health assistant anytime for instant support and guidance.",
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center transform scale-[0.8] origin-top">
              <div className="space-y-8 text-center lg:text-left">
                ...
                <p className="text-xl sm:text-2xl text-gray-600 max-w-2xl mx-auto lg:mx-0 leading-relaxed">
                  Experience the future of personal health management with
                  AI-powered insights, real-time monitoring, and intelligent
                  symptom tracking.
                </p>
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                  <Link to="/login">
                    <Button
                      size="lg"
                      className="group relative overflow-hidden bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 shadow-xl hover:shadow-2xl w-full sm:w-auto"
                    >
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <div className="text-sm text-blue-100">
                          Your vitals are looking great! Consider increasing
                          water intake by 2 glasses for optimal hydration.
                        </div>
                      </div>
                    </div>
                  </div>
          ...
          <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
            <div className="text-center mb-20">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Everything you need to monitor, track, and improve your health
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {features.map((feature, index) => (
                ...
                >
                  <div
                    className={`absolute inset-0 rounded-2xl bg-gradient-to-br ${feature.gradient} opacity-0 group-hover:opacity-100 transition-opacity -z-10 blur-xl`}
                  ></div>
          ...
          <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
            ...
            <div className="grid md:grid-cols-3 gap-12 relative">
              ...
              <div className="relative text-center">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Log symptoms, chat with AI, and monitor your health metrics in
                  real-time.
                </p>
              </div>
              ...
              <div className="relative text-center">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Receive personalized recommendations and early anomaly
                  detection alerts.
                </p>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-gradient-to-br from-blue-50 to-purple-50 rounded-2xl p-8 border border-blue-100 hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-700 mb-6 italic leading-relaxed">
                  "This app changed how I manage my health. The AI insights are
              ...
              <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-2xl p-8 border border-purple-100 hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-700 mb-6 italic leading-relaxed">
                  "The 3D body mapping feature is genius! Makes tracking
                  symptoms so much easier and intuitive."
                </p>
                <div className="flex items-center gap-3">
              ...
              <div className="bg-gradient-to-br from-green-50 to-teal-50 rounded-2xl p-8 border border-green-100 hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-700 mb-6 italic leading-relaxed">
                  "The anomaly detection caught a pattern I didn't notice.
        ...
        <section className="py-24 bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 text-white relative overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto px-6 sm:px-8 lg:px-12 text-center relative z-10">
            ...
            <p className="text-xl sm:text-2xl text-blue-100 mb-12 leading-relaxed">
              Join 50,000+ users who trust AI Health Copilot for their health
              management
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link to="/login">
                <Button
                  size="lg"
                  variant="secondary"
                  className="bg-white text-purple-600 hover:bg-gray-100 shadow-2xl w-full sm:w-auto"
                >

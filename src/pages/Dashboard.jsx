...
const Dashboard = () => {
  ...
  const handleFeelingSubmit = (e) => {
    ...
    if (selectedFeeling) {
      alert(
        `Feeling logged: ${feelings.find((f) => f.id === selectedFeeling)?.label}`,
      );
          ...
          {healthMetrics.map((metric) => (
            ...
            >
              ...
              <div className="flex items-center justify-between pt-3 border-t border-gray-100">
                <span
                  className={`text-xs font-semibold px-3 py-1 rounded-full bg-gradient-to-r ${metric.bgColor}`}
                >
                  {metric.status}
                </span>
                <span
              ...
              <form onSubmit={handleFeelingSubmit} className="space-y-5">
                ...
                {selectedFeeling && (
                  <div className="space-y-3 animate-fadeIn">
                    ...
                    <Button
                      type="submit"
                      className="w-full bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 py-3 shadow-lg"
                    >
                      <svg
              ...
              <div className="flex justify-between items-end gap-2 h-48">
                {moodData.map((day, index) => (
                  ...
                  >
                    ...
                    <div className="text-2xl mt-2 group-hover:scale-125 transition-transform">
                      {day.mood}
                    </div>
                  </div>
                ))}
